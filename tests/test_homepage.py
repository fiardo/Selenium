...
class Test_Homepage_class(Invokation):
    ...
    services_sequence = ['Accommodation',
                         'Student Flight Tickets', 'Guarantor']
    mediaPage_url = 'https://www.universityliving.com/press-release'

    @mark.testomatio('@T0262ccf2')
    def test_homepageValidations(self):
        ...
        lstNames = []
        TopcityOrder = ['London', 'Nottingham', 'Cardiff', 'Melbourne',
                        'Birmingham', 'Liverpool', 'Toronto', 'New York']
        BedsCountSequence = {'London': '95436 Beds', 'Nottingham': '35444 Beds', 'Leeds': '22088 Beds', 'Melbourne': '59946 Beds',
                             'Birmingham': '29276 Beds', 'Liverpool': '29342 Beds', 'Toronto': '16706 Beds', 'New York': '25044 Beds'}
        topcitiesResponse = requests.get(
            Test_Homepage_class.topCitiesAndBedCountApi)
        log.info('Top cities api response ->' +
                 str(topcitiesResponse.status_code))
