...
class Test_Homepage_class(Invokation):
    ...
    def test_homepageValidations(self):
        ...
        if (
            DownloadApp.iosButton().is_displayed()
            and DownloadApp.playstoreButton().is_displayed()
        ):
        ...
        BedsCountSequence = {
            "London": "95436 Beds",
            "Nottingham": "35444 Beds",
            "Leeds": "22088 Beds",
            "Melbourne": "59946 Beds",
            "Birmingham": "29276 Beds",
            "Liverpool": "29342 Beds",
            "Toronto": "16706 Beds",
            "New York": "25044 Beds",
        }
