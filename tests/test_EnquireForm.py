...
class Test_EnquireForms(Invokation):
    ...
    def test_enquireE2e(self):
        ...
        enquireformObj.email().send_keys("pravin.garg@universityliving.com")
        enquireformObj.phoneNumber().send_keys("8871555179")
        ...
        time.sleep(5)
        self.driver.get_screenshot_as_file("C:\\Users\\TUL\\Desktop\\python\\FrameWorkDesign2\\logs&Repos\\forms\\enquireNow.png")
