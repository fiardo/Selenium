...
class Test_SignupE2e(Invokation):
    ...
    def test_E2eLogin(self):
        ...
        dashboard_email = self.driver.find_element(
            By.CSS_SELECTOR, '.text-base.text-theme-gray-text.truncate').text
        ...
        log.info('used contact number for sign up -->' +
                 Test_SignupE2e.phone_number)
