...
class detailpageClass:
    ...
    # ------------------------------- room details selectors ------------------------
    stayDurationText_selector = (By.XPATH, "//li[@data-label='Stay Duration']/p")
    moveText_selector = (By.XPATH, "//li[@data-label='Move']/div/div")
    occupancyText_selector = (By.XPATH, "//li[@data-label='Occupancy']/p")
    priceText_selector = (By.XPATH, "//li[@data-label='Price']/p")
    totalText_selector = (By.XPATH, "//li[@data-label='Total']/p")
    # ----------------------------------form details -----------------------------------------------

    formTotalPrice_selector = (By.XPATH, "//span[@automation_id='Total']")
    formPrice_selector = (By.XPATH, "//span[@automation_id='Price']")
    formMoveIn_selector = (By.XPATH, "//p[@automation_id='checkInDate']")
    formMoveOut_selector = (By.XPATH, "//p[@automation_id='checkOutDate']")
    formDuration_selector = (By.XPATH, "//span[@automation_id='Duration']")
    formRoomName_selector = (By.XPATH, "//span[@automation_id='Room_Type']")
    ...
    def cancellationPolicySection(self):
        return self.driver.find_element(
            *detailpageClass.cancellationPolicySection_selector
        )
    ...
    def propertyNameInSummaryCard(self):
        return self.driver.find_element(
            *detailpageClass.propertyNameInSummaryCard_selector
        )
    ...
    def formTotalPrice(self):
        return self.driver.find_element(*detailpageClass.formTotalPrice_selector)

    def formPrice(self):
        return self.driver.find_element(*detailpageClass.formPrice_selector)

    def formMoveIn(self):
        return self.driver.find_element(*detailpageClass.formMoveIn_selector)

    def formMoveOut(self):
        return self.driver.find_element(*detailpageClass.formMoveOut_selector)

    def formDuration(self):
        return self.driver.find_element(*detailpageClass.formDuration_selector)

    def formRoomName(self):
        return self.driver.find_element(*detailpageClass.formRoomName_selector)

    # --------------------------------room detail method--------------------------

    def stayDurationText(self):
        return self.driver.find_element(*detailpageClass.stayDurationText_selector)

    def moveText(self):
        return self.driver.find_element(*detailpageClass.moveText_selector)

    def occupancyText(self):
        return self.driver.find_element(*detailpageClass.occupancyText_selector)

    def priceText(self):
        return self.driver.find_element(*detailpageClass.priceText_selector)

    def totalText(self):
        return self.driver.find_element(*detailpageClass.totalText_selector)
