...
class FormClass:
    ...
    pastAttendedUni_selector = (
        By.XPATH,
        "//input[@placeholder='Search Past Attended University/College/School']",
    )
    pastAttendUniSelection_selector = (By.ID, "previousUniversity-item-0")

    pastAttendedCourse_selector = (
        By.XPATH,
        "//input[@placeholder='Search Past Attended Course']",
    )
    pastAttendCourseSelection_selector = (By.ID, "previousCourseName-item-0")
    ...
    uniPlaceHolderValue_selector = (
        By.XPATH,
        "//input[@placeholder='University (eg. London University)']",
    )
    ...
    def pastUniField(self):
        return self.driver.find_element(*FormClass.pastAttendedUni_selector)

    def pastUniFieldItemOne(self):
        return self.driver.find_element(*FormClass.pastAttendUniSelection_selector)

    def pastCourseField(self):
        return self.driver.find_element(*FormClass.pastAttendedCourse_selector)

    def pastCourseFieldItemOne(self):
        return self.driver.find_element(*FormClass.pastAttendCourseSelection_selector)
    ...
    def uniPlaceholderValue(self):
        return self.driver.find_element(*FormClass.uniPlaceHolderValue_selector)
